...
function displayWeekContent() {
    ...
    for (let i = 0; i < todolist.length; i++) {
        ...
        todoobj.dueDate===format(addDays(todayDate, 1), 'yyyy-MM-dd') ||
        todoobj.dueDate===format(addDays(todayDate, 2), 'yyyy-MM-dd') ||
        todoobj.dueDate===format(addDays(todayDate, 3), 'yyyy-MM-dd') ||
        todoobj.dueDate===format(addDays(todayDate, 4), 'yyyy-MM-dd') ||
        todoobj.dueDate===format(addDays(todayDate, 5), 'yyyy-MM-dd') ||
        todoobj.dueDate===format(addDays(todayDate, 6), 'yyyy-MM-dd')){
